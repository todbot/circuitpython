...
static bool fetch_source_buffer(audiocore_speedchanger_obj_t *self) {
...
void audiocore_speedchanger_reset_buffer(audiocore_speedchanger_obj_t *self,
...
audioio_get_buffer_result_t audiocore_speedchanger_get_buffer(audiocore_speedchanger_obj_t *self,
    bool single_channel_output, uint8_t channel,
